...
def show(account_name, policy_id, rule_id, resource_group=None, **kwargs):
    '''
...
def list(account_name, policy_id, resource_group=None, **kwargs):
    '''
...
def add(account_name, destination_container, policy_id, source_container, min_creation_time=None, prefix_match=None, resource_group=None, **kwargs):
    '''
...
def update(account_name, policy_id, rule_id, destination_container=None, min_creation_time=None, prefix_match=None, resource_group=None, source_container=None, **kwargs):
    '''
...
def remove(account_name, policy_id, rule_id, resource_group=None, **kwargs):
    '''
