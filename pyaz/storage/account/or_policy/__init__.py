...
def show(account_name, policy_id, resource_group=None, **kwargs):
    '''
...
def create(account_name, destination_account=None, destination_container=None, min_creation_time=None, policy=None, policy_id=None, prefix_match=None, resource_group=None, rule_id=None, source_account=None, source_container=None, **kwargs):
    '''
...
def update(account_name, add=None, destination_account=None, force_string=None, policy=None, policy_id=None, remove=None, resource_group=None, set=None, source_account=None, **kwargs):
    '''
...
def delete(account_name, policy_id, resource_group=None, **kwargs):
    '''
