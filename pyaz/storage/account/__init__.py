...
def show(name, expand=None, resource_group=None, **kwargs):
    '''
...
def show_usage(location, **kwargs):
    '''
...
def show_connection_string(name, blob_endpoint=None, file_endpoint=None, key=None, protocol=None, queue_endpoint=None, resource_group=None, sas_token=None, table_endpoint=None, **kwargs):
    '''
...
def failover(name, no_wait=None, resource_group=None, yes=None, **kwargs):
    '''
...
def revoke_delegation_keys(name, resource_group=None, **kwargs):
    '''
...
def generate_sas(expiry, permissions, resource_types, services, account_key=None, account_name=None, connection_string=None, https_only=None, ip=None, start=None, **kwargs):
    '''
