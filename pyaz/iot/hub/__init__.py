...
def show_connection_string(all=None, hub_name=None, key=None, policy_name=None, resource_group=None, **kwargs):
    '''
...
def delete(name, resource_group=None, **kwargs):
    '''
    Delete an IoT hub.
    '''
...
def list_skus(name, resource_group=None, **kwargs):
    '''
...
def show_quota_metrics(name, resource_group=None, **kwargs):
    '''
...
def show_stats(name, resource_group=None, **kwargs):
    '''
...
def manual_failover(name, no_wait=None, resource_group=None, **kwargs):
    '''
