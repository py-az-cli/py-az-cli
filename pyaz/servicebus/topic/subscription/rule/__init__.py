...
def show(name, namespace_name, resource_group, subscription_name, topic_name, **kwargs):
    '''
...
def list(namespace_name, resource_group, subscription_name, topic_name, skip=None, top=None, **kwargs):
    '''
...
def delete(name, namespace_name, resource_group, subscription_name, topic_name, **kwargs):
    '''
