...
def create(name, namespace_name, resource_group, topic_name, rights=None, **kwargs):
    '''
...
def show(name, namespace_name, resource_group, topic_name, **kwargs):
    '''
...
def list(namespace_name, resource_group, topic_name, **kwargs):
    '''
...
def delete(name, namespace_name, resource_group, topic_name, **kwargs):
    '''
...
def update(name, namespace_name, resource_group, rights, topic_name, add=None, force_string=None, remove=None, set=None, **kwargs):
    '''
    Create Authorization Rule for given Service Bus Topic
    '''
