...
def show(database_name, rule_id, server_name, vm_resource_id, workspace_id, agent_id=None, vm_name=None, vm_uuid=None, **kwargs):
    '''
...
def delete(database_name, rule_id, server_name, vm_resource_id, workspace_id, agent_id=None, vm_name=None, vm_uuid=None, **kwargs):
    '''
...
def update(database_name, rule_id, server_name, vm_resource_id, workspace_id, agent_id=None, baseline=None, latest=None, vm_name=None, vm_uuid=None, **kwargs):
    '''
...
def set(database_name, server_name, vm_resource_id, workspace_id, agent_id=None, baseline=None, latest=None, vm_name=None, vm_uuid=None, **kwargs):
    '''
