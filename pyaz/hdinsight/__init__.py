...
def resize(name, resource_group, workernode_count, no_wait=None, **kwargs):
    '''
...
def rotate_disk_encryption_key(encryption_key_name, encryption_key_version, encryption_vault_uri, name, resource_group, no_wait=None, **kwargs):
    '''
...
def update(name, resource_group, no_wait=None, tags=None, **kwargs):
    '''
