...
def create(cluster_name, name, resource_group, script_action_name, script_uri, access_mode=None, destination_port=None, disable_gateway_auth=None, edgenode_size=None, marketplace_id=None, no_validation_timeout=None, script_parameters=None, ssh_password=None, ssh_public_key=None, ssh_user=None, sub_domain_suffix=None, subnet=None, tags=None, type=None, vnet_name=None, **kwargs):
    '''
...
def delete(cluster_name, name, resource_group, no_wait=None, yes=None, **kwargs):
