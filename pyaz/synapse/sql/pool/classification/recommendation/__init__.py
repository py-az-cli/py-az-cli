...
def list(name, resource_group, workspace_name, filter=None, included_disabled=None, skip_token=None, **kwargs):
    '''
...
def enable(column, name, resource_group, schema, table, workspace_name, **kwargs):
    '''
...
def disable(column, name, resource_group, schema, table, workspace_name, **kwargs):
    '''
