...
def show_sql_access(resource_group, workspace_name, **kwargs):
    '''
...
def grant_sql_access(resource_group, workspace_name, no_wait=None, **kwargs):
    '''
...
def revoke_sql_access(resource_group, workspace_name, no_wait=None, **kwargs):
    '''
