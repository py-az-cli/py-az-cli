...
def create(key_identifier, name, resource_group, workspace_name, no_wait=None, **kwargs):
    '''
...
def wait(key_name, resource_group, workspace_name, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
