...
def create(end_ip_address, name, resource_group, start_ip_address, workspace_name, no_wait=None, **kwargs):
    '''
...
def update(name, resource_group, workspace_name, end_ip_address=None, no_wait=None, start_ip_address=None, **kwargs):
    '''
...
def wait(resource_group, rule_name, workspace_name, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
