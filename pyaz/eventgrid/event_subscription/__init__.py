...
def show(name, include_full_endpoint_url=None, include_static_delivery_attribute_secret=None, source_resource_id=None, **kwargs):
    '''
...
def delete(name, source_resource_id=None, **kwargs):
    '''
...
def list(location=None, odata_query=None, resource_group=None, source_resource_id=None, topic_type_name=None, **kwargs):
    '''
