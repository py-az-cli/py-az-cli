...
def show(name, resource_group, system_topic_name, include_full_endpoint_url=None, include_static_delivery_attribute_secret=None, **kwargs):
    '''
...
def delete(name, resource_group, system_topic_name, yes=None, **kwargs):
    '''
...
def list(resource_group, system_topic_name, odata_query=None, **kwargs):
    '''
