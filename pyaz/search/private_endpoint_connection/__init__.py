...
def show(private_endpoint_connection_name, resource_group, service_name, **kwargs):
    return call_az("az search private-endpoint-connection show", locals())


def delete(private_endpoint_connection_name, resource_group, service_name, yes=None, **kwargs):
    return call_az("az search private-endpoint-connection delete", locals())


def update(actions_required, description, name, resource_group, service_name, status, **kwargs):
