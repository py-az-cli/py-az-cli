...
def add(access_key, account_name, custom_id, name, resource_group, share_name, storage_type, mount_path=None, slot=None, slot_setting=None, **kwargs):
    '''
...
def update(custom_id, name, resource_group, access_key=None, account_name=None, mount_path=None, share_name=None, slot=None, slot_setting=None, storage_type=None, **kwargs):
    '''
...
def delete(custom_id, name, resource_group, slot=None, **kwargs):
    '''
