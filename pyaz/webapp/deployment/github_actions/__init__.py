...
def add(name, repo, resource_group, branch=None, force=None, login_with_github=None, runtime=None, slot=None, token=None, **kwargs):
    '''
...
def remove(name, repo, resource_group, branch=None, login_with_github=None, slot=None, token=None, **kwargs):
    '''
