...
def tail(name, resource_group, provider=None, slot=None, **kwargs):
    '''
...
def download(name, resource_group, log_file=None, slot=None, **kwargs):
    '''
...
def config(name, resource_group, application_logging=None, detailed_error_messages=None, docker_container_logging=None, failed_request_tracing=None, level=None, slot=None, web_server_logging=None, **kwargs):
    '''
