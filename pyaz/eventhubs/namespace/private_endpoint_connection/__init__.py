...
def delete(id=None, name=None, namespace_name=None, resource_group=None, yes=None, **kwargs):
    '''
...
def show(id=None, name=None, namespace_name=None, resource_group=None, **kwargs):
    '''
...
def approve(description=None, id=None, name=None, namespace_name=None, resource_group=None, **kwargs):
    '''
...
def reject(description=None, id=None, name=None, namespace_name=None, resource_group=None, **kwargs):
    '''
