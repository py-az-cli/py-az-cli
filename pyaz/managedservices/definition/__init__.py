...
def create(name, principal_id, role_definition_id, tenant_id, definition_id=None, description=None, plan_name=None, plan_product=None, plan_publisher=None, plan_version=None, **kwargs):
    '''
