...
def list(experiment, job, resource_group, workspace, **kwargs):
    '''
...
def exec(experiment, job, resource_group, workspace, address=None, exec=None, node_id=None, password=None, ssh_private_key=None, **kwargs):
    '''
