...
def list(resource_group, server_name):
    ...
    '''
    return _call_az("az mariadb server replica list", locals())
...
def create(name, resource_group, source_server, location=None, no_wait=None, sku_name=None):
    ...
    '''
    return _call_az("az mariadb server replica create", locals())
...
def stop(name, resource_group, yes=None):
    ...
    '''
    return _call_az("az mariadb server replica stop", locals())
