...
def create(master_subnet, name, resource_group, worker_subnet, apiserver_visibility=None, client_id=None, client_secret=None, cluster_resource_group=None, domain=None, ingress_visibility=None, location=None, master_vm_size=None, no_wait=None, pod_cidr=None, pull_secret=None, service_cidr=None, tags=None, vnet=None, vnet_resource_group=None, worker_count=None, worker_vm_disk_size_gb=None, worker_vm_size=None, **kwargs):
    '''
    Create a cluster.
    '''
...
def update(name, resource_group, client_id=None, client_secret=None, no_wait=None, refresh_credentials=None, **kwargs):
    '''
    Update a cluster.
    '''
...
def list_credentials(name, resource_group, **kwargs):
    '''
