...
def scale(cluster_name, name, resource_group, no_wait=None, node_count=None, **kwargs):
    '''
...
def upgrade(cluster_name, name, resource_group, kubernetes_version=None, max_surge=None, no_wait=None, node_image_only=None, **kwargs):
    '''
...
def update(cluster_name, name, resource_group, disable_cluster_autoscaler=None, enable_cluster_autoscaler=None, labels=None, max_count=None, max_surge=None, min_count=None, mode=None, no_wait=None, tags=None, update_cluster_autoscaler=None, **kwargs):
    '''
...
def delete(cluster_name, name, resource_group, no_wait=None, **kwargs):
    '''
...
def get_upgrades(cluster_name, nodepool_name, resource_group, **kwargs):
    '''
