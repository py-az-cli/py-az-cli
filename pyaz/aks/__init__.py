...
def browse(name, resource_group, disable_browser=None, listen_address=None, listen_port=None, **kwargs):
    '''
...
def update_credentials(name, resource_group, aad_client_app_id=None, aad_server_app_id=None, aad_server_app_secret=None, aad_tenant_id=None, client_secret=None, no_wait=None, reset_aad=None, reset_service_principal=None, service_principal=None, **kwargs):
    '''
...
def disable_addons(addons, name, resource_group, no_wait=None, **kwargs):
    '''
...
def enable_addons(addons, name, resource_group, appgw_id=None, appgw_name=None, appgw_subnet_cidr=None, appgw_subnet_id=None, appgw_watch_namespace=None, enable_secret_rotation=None, enable_sgxquotehelper=None, no_wait=None, rotation_poll_interval=None, subnet_name=None, workspace_resource_id=None, **kwargs):
    '''
...
def get_credentials(name, resource_group, admin=None, context=None, file=None, overwrite_existing=None, public_fqdn=None, **kwargs):
    '''
...
def check_acr(acr, name, resource_group, **kwargs):
    '''
...
def get_upgrades(name, resource_group, **kwargs):
    '''
...
def install_cli(base_src_url=None, client_version=None, install_location=None, kubelogin_base_src_url=None, kubelogin_install_location=None, kubelogin_version=None, **kwargs):
    '''
...
def remove_dev_spaces(name, resource_group, yes=None, **kwargs):
    '''
...
def scale(name, node_count, resource_group, no_wait=None, nodepool_name=None, **kwargs):
    '''
...
def upgrade(name, resource_group, control_plane_only=None, kubernetes_version=None, no_wait=None, node_image_only=None, yes=None, **kwargs):
    '''
...
def use_dev_spaces(name, resource_group, endpoint=None, space=None, update=None, yes=None, **kwargs):
    '''
...
def rotate_certs(name, resource_group, no_wait=None, yes=None, **kwargs):
    '''
...
def get_versions(location, **kwargs):
    '''
