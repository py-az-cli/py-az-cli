...
def create(branch, location, name, resource_group, source, api_location=None, app_location=None, login_with_github=None, no_wait=None, output_location=None, sku=None, tags=None, token=None, **kwargs):
    '''
...
def disconnect(name, no_wait=None, resource_group=None, **kwargs):
    '''
...
def reconnect(branch, name, source, login_with_github=None, no_wait=None, resource_group=None, token=None, **kwargs):
    '''
...
def update(name, branch=None, no_wait=None, sku=None, source=None, tags=None, token=None, **kwargs):
    '''
