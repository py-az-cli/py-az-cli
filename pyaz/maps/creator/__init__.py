...
def show(creator_name, name, resource_group, **kwargs):
    '''
...
def create(creator_name, name, resource_group, storage_units, location=None, tags=None, **kwargs):
    '''
...
def update(creator_name, name, resource_group, storage_units=None, tags=None, **kwargs):
    '''
...
def delete(creator_name, name, resource_group, yes=None, **kwargs):
    '''
