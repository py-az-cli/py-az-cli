...
def grant_access(duration_in_seconds, name, resource_group, access_level=None, **kwargs):
    '''
...
def update(name, resource_group, accelerated_network=None, add=None, disk_access=None, disk_encryption_set=None, encryption_type=None, force_string=None, network_access_policy=None, no_wait=None, public_network_access=None, remove=None, set=None, sku=None, **kwargs):
    '''
    Update a snapshot.
    '''
