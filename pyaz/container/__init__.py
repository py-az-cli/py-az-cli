...
def logs(name, resource_group, container_name=None, follow=None, **kwargs):
    '''
...
def exec(exec_command, name, resource_group, container_name=None, **kwargs):
    '''
...
def export(file, name, resource_group, **kwargs):
    '''
...
def attach(name, resource_group, container_name=None, **kwargs):
    '''
...
def restart(name, resource_group, no_wait=None, **kwargs):
