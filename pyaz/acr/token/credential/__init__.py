...
def delete(name, registry, password1=None, password2=None, resource_group=None, **kwargs):
    '''
...
def generate(name, registry, expiration=None, expiration_in_days=None, password1=None, password2=None, resource_group=None, **kwargs):
    '''
