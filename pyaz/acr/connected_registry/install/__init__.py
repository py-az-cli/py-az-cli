...
def info(name, parent_protocol, registry, resource_group=None, **kwargs):
    '''
...
def renew_credentials(name, parent_protocol, registry, resource_group=None, yes=None, **kwargs):
    '''
