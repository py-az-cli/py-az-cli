...
def show(name, registry, resource_group=None, with_secure_properties=None, **kwargs):
    '''
...
def run(name, registry, agent_pool=None, arg=None, context=None, file=None, log_template=None, no_logs=None, no_wait=None, resource_group=None, secret_arg=None, set=None, set_secret=None, target=None, update_trigger_token=None, **kwargs):
    '''
...
def list_runs(registry, image=None, name=None, resource_group=None, run_status=None, top=None, **kwargs):
    '''
...
def show_run(registry, run_id, resource_group=None, **kwargs):
    '''
...
def cancel_run(registry, run_id, resource_group=None, **kwargs):
    '''
...
def update_run(registry, run_id, no_archive=None, resource_group=None, **kwargs):
    '''
...
def logs(registry, image=None, name=None, resource_group=None, run_id=None, **kwargs):
    '''
