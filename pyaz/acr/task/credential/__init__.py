...
def add(login_server, name, registry, password=None, resource_group=None, use_identity=None, username=None, **kwargs):
    '''
...
def update(login_server, name, registry, password=None, resource_group=None, use_identity=None, username=None, **kwargs):
    '''
...
def remove(login_server, name, registry, resource_group=None, **kwargs):
    '''
