...
def create(name, resource_group, sku, admin_enabled=None, allow_exports=None, allow_trusted_services=None, default_action=None, identity=None, key_encryption_key=None, location=None, public_network_enabled=None, tags=None, workspace=None, zone_redundancy=None, **kwargs):
    '''
...
def delete(name, resource_group=None, yes=None, **kwargs):
    '''
...
def show_usage(name, resource_group=None, **kwargs):
    '''
...
def show_endpoints(name, resource_group=None, **kwargs):
    '''
...
def update(name, add=None, admin_enabled=None, allow_exports=None, allow_trusted_services=None, anonymous_pull_enabled=None, data_endpoint_enabled=None, default_action=None, force_string=None, public_network_enabled=None, remove=None, resource_group=None, set=None, sku=None, tags=None, **kwargs):
    '''
...
def login(name, expose_token=None, password=None, resource_group=None, suffix=None, username=None, **kwargs):
    '''
...
def import_(name, source, force=None, image=None, no_wait=None, password=None, registry=None, repository=None, resource_group=None, username=None, **kwargs):
    '''
...
def build(registry, agent_pool=None, auth_mode=None, build_arg=None, file=None, image=None, log_template=None, no_format=None, no_logs=None, no_push=None, no_wait=None, platform=None, resource_group=None, secret_build_arg=None, target=None, timeout=None, **kwargs):
    '''
...
def run(registry, agent_pool=None, auth_mode=None, file=None, log_template=None, no_format=None, no_logs=None, no_wait=None, platform=None, resource_group=None, set=None, set_secret=None, timeout=None, values=None, **kwargs):
    '''
...
def check_health(ignore_errors=None, name=None, vnet=None, yes=None, **kwargs):
    '''
