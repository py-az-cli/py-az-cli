...
def create(name, registry, count=None, no_wait=None, os=None, resource_group=None, subnet_id=None, tier=None, **kwargs):
    '''
...
def update(name, registry, count=None, no_wait=None, resource_group=None, **kwargs):
    '''
...
def delete(name, registry, no_wait=None, resource_group=None, yes=None, **kwargs):
    '''
...
def show(name, registry, queue_count=None, resource_group=None, **kwargs):
    '''
