...
def create(name, resource_group, add_disabled=None, calling_web_hook=None, enable_calling=None, enable_groups=None, enable_media_cards=None, enable_messaging=None, enable_screen_sharing=None, enable_video=None, groups_mode=None, **kwargs):
    '''
