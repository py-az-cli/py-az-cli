...
def create(name, resource_group, app_service_environment=None, hyper_v=None, is_linux=None, location=None, no_wait=None, number_of_workers=None, per_site_scaling=None, sku=None, tags=None, zone_redundant=None, **kwargs):
    '''
...
def update(name, resource_group, add=None, force_string=None, no_wait=None, number_of_workers=None, remove=None, set=None, sku=None, **kwargs):
    '''
