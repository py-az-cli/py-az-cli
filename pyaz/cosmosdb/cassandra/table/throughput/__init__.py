...
def update(account_name, keyspace_name, name, resource_group, max_throughput=None, throughput=None, **kwargs):
    '''
...
def migrate(account_name, keyspace_name, name, resource_group, throughput_type, **kwargs):
    '''
