...
def list_read_only_keys(name, resource_group, **kwargs):
    '''
...
def list_connection_strings(name, resource_group, **kwargs):
    '''
...
def regenerate_key(key_kind, name, resource_group, **kwargs):
    '''
...
def check_name_exists(name, **kwargs):
    '''
...
def failover_priority_change(failover_policies, name, resource_group, **kwargs):
    '''
...
def restore(account_name, location, resource_group, restore_timestamp, target_database_account_name, databases_to_restore=None, **kwargs):
    '''
