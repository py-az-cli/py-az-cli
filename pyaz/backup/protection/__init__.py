...
def check_vm(resource_group=None, vm=None, vm_id=None, **kwargs):
    '''
...
def enable_for_vm(policy_name, resource_group, vault_name, vm, disk_list_setting=None, diskslist=None, exclude_all_data_disks=None, **kwargs):
    '''
...
def update_for_vm(container_name, item_name, resource_group, vault_name, disk_list_setting=None, diskslist=None, exclude_all_data_disks=None, **kwargs):
    '''
...
def backup_now(item_name, resource_group, vault_name, backup_management_type=None, backup_type=None, container_name=None, enable_compression=None, retain_until=None, workload_type=None, **kwargs):
    '''
...
def disable(container_name, item_name, resource_group, vault_name, backup_management_type=None, delete_backup_data=None, workload_type=None, yes=None, **kwargs):
    '''
...
def enable_for_azurefileshare(azure_file_share, policy_name, resource_group, storage_account, vault_name, **kwargs):
    '''
...
def enable_for_azurewl(policy_name, protectable_item_name, protectable_item_type, resource_group, server_name, vault_name, workload_type, **kwargs):
    '''
...
def auto_enable_for_azurewl(policy_name, protectable_item_name, protectable_item_type, resource_group, server_name, vault_name, workload_type, **kwargs):
    '''
...
def auto_disable_for_azurewl(protectable_item_name, protectable_item_type, resource_group, server_name, vault_name, workload_type, **kwargs):
    '''
...
def resume(container_name, item_name, policy_name, resource_group, vault_name, backup_management_type=None, workload_type=None, **kwargs):
    '''
...
def undelete(container_name, item_name, resource_group, vault_name, backup_management_type=None, workload_type=None, **kwargs):
    '''
