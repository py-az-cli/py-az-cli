...
def create(days, device_name, name, rate_in_mbps, resource_group, start, stop, no_wait=None, **kwargs):
    '''
...
def update(days, device_name, name, rate_in_mbps, resource_group, start, stop, add=None, force_string=None, no_wait=None, remove=None, set=None, **kwargs):
    '''
...
def delete(device_name, name, resource_group, no_wait=None, yes=None, **kwargs):
    '''
...
def wait(device_name, name, resource_group, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
