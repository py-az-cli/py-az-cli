...
def list(management_group_id, filter=None, **kwargs):
    '''
...
def show(management_group_id, name, **kwargs):
    '''
...
def delete(management_group_id, name, no_wait=None, **kwargs):
    '''
...
def validate(location, management_group_id, handle_extended_json_format=None, name=None, no_prompt=None, parameters=None, query_string=None, template_file=None, template_spec=None, template_uri=None, **kwargs):
    '''
...
def what_if(location, management_group_id, exclude_change_types=None, name=None, no_pretty_print=None, no_prompt=None, parameters=None, query_string=None, result_format=None, template_file=None, template_spec=None, template_uri=None, **kwargs):
    '''
...
def export(management_group_id, name, **kwargs):
    '''
...
def wait(management_group_id, name, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
...
def cancel(management_group_id, name, **kwargs):
    '''
