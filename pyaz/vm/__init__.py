...
def capture(name, resource_group, vhd_name_prefix, overwrite=None, storage_container=None, **kwargs):
    '''
...
def deallocate(name, resource_group, hibernate=None, no_wait=None, **kwargs):
    '''
    Deallocate a VM.
    '''
...
def delete(name, resource_group, force_deletion=None, no_wait=None, yes=None, **kwargs):
    '''
    Delete a VM.
    '''
...
def generalize(name, resource_group, no_wait=None, **kwargs):
    '''
...
def list(resource_group=None, show_details=None, **kwargs):
    '''
...
def list_ip_addresses(name=None, resource_group=None, **kwargs):
    '''
...
def list_sizes(location, **kwargs):
    '''
...
def list_skus(all=None, location=None, resource_type=None, size=None, zone=None, **kwargs):
    '''
...
def list_usage(location, **kwargs):
    '''
...
def list_vm_resize_options(name, resource_group, **kwargs):
    '''
...
def open_port(name, port, resource_group, apply_to_subnet=None, nsg_name=None, priority=None, **kwargs):
    '''
...
def redeploy(name, resource_group, no_wait=None, **kwargs):
    '''
...
def resize(name, resource_group, size, no_wait=None, **kwargs):
    '''
    Update a VM's size.
    '''
...
def restart(name, resource_group, force=None, no_wait=None, **kwargs):
    '''
    Restart VMs.
    '''
...
def show(name, resource_group, include_user_data=None, show_details=None, **kwargs):
    '''
...
def stop(name, resource_group, no_wait=None, skip_shutdown=None, **kwargs):
    '''
...
def reapply(name, resource_group, no_wait=None, **kwargs):
    '''
    Reapply VMs.
    '''
...
def auto_shutdown(name, resource_group, email=None, location=None, off=None, time=None, webhook=None, **kwargs):
    '''
...
def install_patches(maximum_duration, name, reboot_setting, resource_group, classifications_to_include_linux=None, classifications_to_include_win=None, exclude_kbs_requiring_reboot=None, kb_numbers_to_exclude=None, kb_numbers_to_include=None, no_wait=None, package_name_masks_to_exclude=None, package_name_masks_to_include=None, **kwargs):
    '''
