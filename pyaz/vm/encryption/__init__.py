...
def enable(disk_encryption_keyvault, name, resource_group, aad_client_cert_thumbprint=None, aad_client_id=None, aad_client_secret=None, encrypt_format_all=None, force=None, key_encryption_algorithm=None, key_encryption_key=None, key_encryption_keyvault=None, volume_type=None, **kwargs):
    '''
