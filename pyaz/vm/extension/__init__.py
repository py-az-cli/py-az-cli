...
def delete(name, resource_group, vm_name, no_wait=None, **kwargs):
    '''
...
def show(name, resource_group, vm_name, expand=None, **kwargs):
    '''
...
def set(name, publisher, resource_group, vm_name, enable_auto_upgrade=None, extension_instance_name=None, force_update=None, no_auto_upgrade_minor_version=None, no_wait=None, protected_settings=None, settings=None, version=None, **kwargs):
    '''
...
def wait(name, resource_group, vm_name, created=None, custom=None, deleted=None, exists=None, expand=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
