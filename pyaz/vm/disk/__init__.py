...
def attach(name, resource_group, vm_name, caching=None, enable_write_accelerator=None, lun=None, new=None, size_gb=None, sku=None, **kwargs):
    '''
...
def detach(name, resource_group, vm_name, **kwargs):
    '''
