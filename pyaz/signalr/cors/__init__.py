...
def add(allowed_origins, name, resource_group, **kwargs):
    '''
...
def remove(allowed_origins, name, resource_group, **kwargs):
    '''
...
def update(allowed_origins, name, resource_group, **kwargs):
    '''
