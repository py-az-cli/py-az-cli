...
def create(account_name, resource_group, name=None, new_sp_name=None, password=None, role=None, xml=None, years=None, **kwargs):
    '''
...
def reset_credentials(account_name, resource_group, name=None, password=None, role=None, xml=None, years=None, **kwargs):
    '''
