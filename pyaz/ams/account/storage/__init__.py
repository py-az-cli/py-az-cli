...
def add(account_name, name, resource_group, **kwargs):
    '''
...
def remove(account_name, name, resource_group, **kwargs):
    '''
...
def set_authentication(account_name, resource_group, storage_auth, **kwargs):
    '''
...
def sync_storage_keys(account_name, resource_group, storage_account_id, **kwargs):
    '''
