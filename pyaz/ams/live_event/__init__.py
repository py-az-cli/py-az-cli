...
def standby(account_name, name, resource_group, no_wait=None, **kwargs):
    '''
...
def stop(account_name, name, resource_group, no_wait=None, remove_outputs_on_stop=None, **kwargs):
    '''
    Stop a live event.
    '''
...
def reset(account_name, name, resource_group, no_wait=None, **kwargs):
    '''
    Reset a live event.
    '''
...
def update(account_name, name, resource_group, add=None, client_access_policy=None, cross_domain_policy=None, description=None, force_string=None, ips=None, key_frame_interval_duration=None, preview_ips=None, remove=None, set=None, tags=None, **kwargs):
    '''
