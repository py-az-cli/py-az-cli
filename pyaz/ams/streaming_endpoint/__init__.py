...
def start(account_name, name, resource_group, no_wait=None, **kwargs):
    '''
...
def stop(account_name, name, resource_group, no_wait=None, **kwargs):
    '''
...
def create(account_name, name, resource_group, scale_units, auto_start=None, availability_set_name=None, cdn_profile=None, cdn_provider=None, client_access_policy=None, cross_domain_policy=None, custom_host_names=None, description=None, ips=None, max_cache_age=None, no_wait=None, tags=None, **kwargs):
    '''
...
def scale(account_name, name, resource_group, scale_units, **kwargs):
    '''
...
def update(account_name, name, resource_group, add=None, cdn_profile=None, cdn_provider=None, client_access_policy=None, cross_domain_policy=None, custom_host_names=None, description=None, disable_cdn=None, force_string=None, ips=None, max_cache_age=None, no_wait=None, remove=None, set=None, tags=None, **kwargs):
    '''
...
def wait(account_name, name, resource_group, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
