...
def create(message, name, policy_definition_reference_id=None, resource_group=None, scope=None, **kwargs):
    '''
...
def list(name, resource_group=None, scope=None, **kwargs):
    '''
...
def delete(message, name, policy_definition_reference_id=None, resource_group=None, scope=None, **kwargs):
    '''
