...
def create(name, namespace_name, resource_group, rights=None, **kwargs):
    '''
...
def update(name, namespace_name, resource_group, rights, add=None, force_string=None, remove=None, set=None, **kwargs):
    '''
