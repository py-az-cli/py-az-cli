...
def create(name, namespace_name, relay_name, resource_group, rights=None, **kwargs):
    '''
...
def show(name, namespace_name, relay_name, resource_group, **kwargs):
    '''
...
def list(namespace_name, relay_name, resource_group, **kwargs):
    '''
...
def delete(name, namespace_name, relay_name, resource_group, **kwargs):
    '''
...
def update(name, namespace_name, relay_name, resource_group, rights, add=None, force_string=None, remove=None, set=None, **kwargs):
    '''
