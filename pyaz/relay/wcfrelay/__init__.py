...
def create(name, namespace_name, relay_type, resource_group, requires_client_authorization=None, requires_transport_security=None, user_metadata=None, **kwargs):
    '''
...
def update(name, namespace_name, resource_group, add=None, force_string=None, relay_type=None, remove=None, set=None, status=None, user_metadata=None, **kwargs):
    '''
