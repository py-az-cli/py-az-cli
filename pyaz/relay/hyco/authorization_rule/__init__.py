...
def create(hybrid_connection_name, name, namespace_name, resource_group, rights=None, **kwargs):
    '''
...
def show(hybrid_connection_name, name, namespace_name, resource_group, **kwargs):
    '''
...
def list(hybrid_connection_name, namespace_name, resource_group, **kwargs):
    '''
...
def delete(hybrid_connection_name, name, namespace_name, resource_group, **kwargs):
    '''
...
def update(hybrid_connection_name, name, namespace_name, resource_group, rights, add=None, force_string=None, remove=None, set=None, **kwargs):
    '''
    Create Authorization Rule for given Relay Service Hybrid Connection
    '''
