...
def list(hybrid_connection_name, name, namespace_name, resource_group, **kwargs):
    '''
...
def renew(hybrid_connection_name, key, name, namespace_name, resource_group, key_value=None, **kwargs):
    '''
