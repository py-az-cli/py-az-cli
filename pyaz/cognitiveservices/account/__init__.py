...
def create(kind, location, name, resource_group, sku, api_properties=None, assign_identity=None, custom_domain=None, encryption=None, storage=None, tags=None, yes=None, **kwargs):
    '''
...
def update(name, resource_group, api_properties=None, custom_domain=None, encryption=None, sku=None, storage=None, tags=None, **kwargs):
    '''
    Manage Azure Cognitive Services accounts.
    '''
...
def show_deleted(location, name, resource_group, **kwargs):
    '''
...
def purge(location, name, resource_group, **kwargs):
    '''
...
def recover(location, name, resource_group, **kwargs):
    '''
...
def list_skus(kind=None, location=None, name=None, resource_group=None, **kwargs):
    '''
    Manage Azure Cognitive Services accounts.
    '''
...
def list_usage(name, resource_group, **kwargs):
    return call_az("az cognitiveservices account list-usage", locals())


def list_kinds(**kwargs):
