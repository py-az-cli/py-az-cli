...
def create(auto_renew, commitment_plan_name, hosting_model, name, plan_type, resource_group, current_count=None, current_tier=None, next_count=None, next_tier=None, **kwargs):
    '''
...
def delete(commitment_plan_name, name, resource_group, **kwargs):
    '''
...
def show(commitment_plan_name, name, resource_group, **kwargs):
    '''
