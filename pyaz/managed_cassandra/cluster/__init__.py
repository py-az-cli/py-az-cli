...
def update(cluster_name, resource_group, authentication_method=None, cassandra_version=None, client_certificates=None, external_gossip_certificates=None, external_seed_nodes=None, hours_between_backups=None, identity_type=None, no_wait=None, repair_enabled=None, tags=None, **kwargs):
    '''
...
def deallocate(cluster_name, resource_group, no_wait=None, **kwargs):
    '''
...
def invoke_command(cluster_name, command_name, host, resource_group, arguments=None, cassandra_stop_start=None, no_wait=None, readwrite=None, **kwargs):
    '''
...
def start(cluster_name, resource_group, no_wait=None, **kwargs):
    '''
...
def status(cluster_name, resource_group, **kwargs):
    '''
...
def show(cluster_name, resource_group, **kwargs):
    '''
...
def delete(cluster_name, resource_group, no_wait=None, yes=None, **kwargs):
    '''
