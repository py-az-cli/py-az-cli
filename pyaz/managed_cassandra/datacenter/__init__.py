...
def update(cluster_name, data_center_name, resource_group, backup_storage_customer_key_uri=None, base64_encoded_cassandra_yaml_fragment=None, managed_disk_customer_key_uri=None, no_wait=None, node_count=None, **kwargs):
    '''
...
def show(cluster_name, data_center_name, resource_group, **kwargs):
    '''
...
def delete(cluster_name, data_center_name, resource_group, no_wait=None, yes=None, **kwargs):
    '''
