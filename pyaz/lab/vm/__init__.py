...
def start(lab_name, name, resource_group, **kwargs):
    return call_az("az lab vm start", locals())


def stop(lab_name, name, resource_group, **kwargs):
    return call_az("az lab vm stop", locals())


def apply_artifacts(lab_name, name, resource_group, artifacts=None, **kwargs):
    '''
...
def list(lab_name, resource_group, all=None, claimable=None, environment=None, expand=None, filters=None, object_id=None, order_by=None, top=None, **kwargs):
    '''
...
def claim(lab_name=None, name=None, resource_group=None, **kwargs):
    '''
