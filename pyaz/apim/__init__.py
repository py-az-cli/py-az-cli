...
def create(name, publisher_email, publisher_name, resource_group, enable_client_certificate=None, enable_managed_identity=None, location=None, no_wait=None, sku_capacity=None, sku_name=None, tags=None, virtual_network=None, **kwargs):
    '''
...
def update(name, resource_group, add=None, enable_client_certificate=None, enable_managed_identity=None, force_string=None, no_wait=None, publisher_email=None, publisher_name=None, remove=None, set=None, sku_capacity=None, sku_name=None, tags=None, virtual_network=None, **kwargs):
    '''
...
def backup(backup_name, name, resource_group, storage_account_container, storage_account_key, storage_account_name, no_wait=None, **kwargs):
    '''
...
def restore(backup_name, name, resource_group, storage_account_container, storage_account_key, storage_account_name, no_wait=None, **kwargs):
    '''
...
def apply_network_updates(name, resource_group, location=None, no_wait=None, **kwargs):
