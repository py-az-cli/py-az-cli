...
def create(display_name, named_value_id, resource_group, service_name, secret=None, tags=None, value=None, **kwargs):
    '''
...
def show(named_value_id, resource_group, service_name, **kwargs):
    '''
...
def delete(named_value_id, resource_group, service_name, yes=None, **kwargs):
    '''
...
def show_secret(named_value_id, resource_group, service_name, **kwargs):
    '''
...
def update(named_value_id, resource_group, service_name, add=None, force_string=None, if_match=None, remove=None, secret=None, set=None, tags=None, value=None, **kwargs):
    '''
