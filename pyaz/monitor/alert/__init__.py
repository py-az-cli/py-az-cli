...
def create(condition, name, target, action=None, description=None, disabled=None, email_service_owners=None, location=None, resource_group=None, tags=None, target_namespace=None, target_parent=None, target_type=None, **kwargs):
    '''
...
def show_incident(name, resource_group, rule_name, **kwargs):
    '''
...
def list_incidents(resource_group, rule_name, **kwargs):
    '''
