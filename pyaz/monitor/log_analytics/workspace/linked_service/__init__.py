...
def create(name, resource_group, workspace_name, no_wait=None, resource_id=None, write_access_resource_id=None, **kwargs):
    '''
...
def update(name, resource_group, workspace_name, add=None, force_string=None, no_wait=None, remove=None, resource_id=None, set=None, write_access_resource_id=None, **kwargs):
    '''
