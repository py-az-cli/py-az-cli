...
def create(resource_group, workspace_name, capacity_reservation_level=None, ingestion_access=None, location=None, no_wait=None, query_access=None, quota=None, retention_time=None, sku=None, tags=None, **kwargs):
    '''
...
def update(resource_group, workspace_name, add=None, capacity_reservation_level=None, force_string=None, ingestion_access=None, query_access=None, quota=None, remove=None, retention_time=None, set=None, tags=None, **kwargs):
    '''
...
def delete(resource_group, workspace_name, force=None, yes=None, **kwargs):
    '''
...
def list_deleted_workspaces(resource_group=None, **kwargs):
    '''
...
def recover(workspace_name, no_wait=None, resource_group=None, **kwargs):
    '''
...
def get_schema(resource_group, workspace_name, **kwargs):
    '''
...
def list_usages(resource_group, workspace_name, **kwargs):
    '''
...
def list_management_groups(resource_group, workspace_name, **kwargs):
    '''
...
def get_shared_keys(resource_group, workspace_name, **kwargs):
    '''
