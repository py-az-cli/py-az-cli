...
def create(address_prefixes=None, admin_password=None, admin_user=None, backup_retention=None, database_name=None, high_availability=None, location=None, name=None, private_dns_zone=None, public_access=None, resource_group=None, sku_name=None, standby_zone=None, storage_size=None, subnet=None, subnet_prefixes=None, tags=None, tier=None, version=None, vnet=None, yes=None, zone=None, **kwargs):
    '''
...
def restore(name, resource_group, source_server, address_prefixes=None, no_wait=None, private_dns_zone=None, restore_time=None, subnet=None, subnet_prefixes=None, vnet=None, yes=None, zone=None, **kwargs):
    '''
...
def update(name, resource_group, add=None, admin_password=None, backup_retention=None, force_string=None, high_availability=None, maintenance_window=None, remove=None, set=None, sku_name=None, standby_zone=None, storage_size=None, tags=None, tier=None, **kwargs):
    '''
