...
def set(function_name, key_name, name, resource_group, key_value=None, slot=None, **kwargs):
    '''
...
def list(function_name, name, resource_group, slot=None, **kwargs):
    '''
...
def delete(key_name, name, resource_group, function_name=None, slot=None, **kwargs):
    '''
