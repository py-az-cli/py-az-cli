...
def create(gallery_name, resource_group, description=None, location=None, permissions=None, soft_delete=None, tags=None, **kwargs):
    '''
...
def show(gallery_name, resource_group, select=None, **kwargs):
...
def delete(gallery_name, resource_group, **kwargs):
    return call_az("az sig delete", locals())


def update(gallery_name, resource_group, add=None, force_string=None, permissions=None, remove=None, select=None, set=None, soft_delete=None, **kwargs):
    '''
...
def list_shared(location, shared_to=None, **kwargs):
    '''
...
def show_shared(gallery_unique_name, location, **kwargs):
    '''
