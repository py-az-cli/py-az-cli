...
def show(gallery_image_definition, gallery_name, resource_group, **kwargs):
    return call_az("az sig image-definition show", locals())


def delete(gallery_image_definition, gallery_name, resource_group, **kwargs):
    return call_az("az sig image-definition delete", locals())


def update(gallery_image_definition, gallery_name, resource_group, add=None, force_string=None, remove=None, set=None, **kwargs):
    '''
...
def list_shared(gallery_unique_name, location, shared_to=None, **kwargs):
    '''
...
def show_shared(gallery_image_definition, gallery_unique_name, location, **kwargs):
    '''
