...
def update(gallery_image_definition, gallery_image_version, gallery_name, resource_group, add=None, force_string=None, no_wait=None, remove=None, replica_count=None, set=None, target_regions=None, **kwargs):
    '''
...
def wait(gallery_image_definition, gallery_image_version, gallery_name, resource_group, created=None, custom=None, deleted=None, exists=None, expand=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
...
def list_shared(gallery_image_definition, gallery_unique_name, location, shared_to=None, **kwargs):
    '''
...
def show_shared(gallery_image_definition, gallery_image_version, gallery_unique_name, location, **kwargs):
    '''
