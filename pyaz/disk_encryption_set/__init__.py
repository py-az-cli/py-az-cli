...
def create(key_url, name, resource_group, source_vault, enable_auto_key_rotation=None, encryption_type=None, location=None, no_wait=None, tags=None, **kwargs):
    '''
...
def update(name, resource_group, add=None, enable_auto_key_rotation=None, force_string=None, key_url=None, remove=None, set=None, source_vault=None, **kwargs):
    '''
...
def list_associated_resources(name, resource_group, **kwargs):
