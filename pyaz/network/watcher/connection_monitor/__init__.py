...
def delete(location, name, resource_group=None, **kwargs):
    '''
...
def stop(location, name, resource_group=None, **kwargs):
    '''
...
def start(location, name, resource_group=None, **kwargs):
    '''
...
def query(location, name, resource_group=None, **kwargs):
    '''
...
def list(location, resource_group=None, **kwargs):
    '''
