...
def create(name, resource_group, vm, capture_limit=None, capture_size=None, file_path=None, filters=None, storage_account=None, storage_path=None, time_limit=None, **kwargs):
    '''
...
def show(location, name, network_watcher_name=None, **kwargs):
    '''
...
def show_status(location, name, network_watcher_name=None, **kwargs):
    '''
...
def delete(location, name, network_watcher_name=None, **kwargs):
    '''
...
def stop(location, name, network_watcher_name=None, **kwargs):
    '''
...
def list(location, network_watcher_name=None, **kwargs):
    '''
