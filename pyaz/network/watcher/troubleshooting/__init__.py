...
def start(resource, storage_account, storage_path, no_wait=None, resource_group=None, resource_type=None, **kwargs):
    '''
...
def show(resource, resource_group=None, resource_type=None, **kwargs):
    '''
