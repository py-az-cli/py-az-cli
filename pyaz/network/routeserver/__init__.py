...
def create(hosted_subnet, name, resource_group, location=None, public_ip_address=None, tags=None, **kwargs):
    '''
...
def update(name, resource_group, add=None, allow_b2b_traffic=None, force_string=None, remove=None, set=None, tags=None, **kwargs):
    '''
