...
def create(name, peer_asn, peer_ip, resource_group, routeserver, no_wait=None, **kwargs):
    '''
...
def update(name, resource_group, routeserver, add=None, force_string=None, peer_asn=None, peer_ip=None, remove=None, set=None, **kwargs):
    '''
...
def delete(name, resource_group, routeserver, no_wait=None, yes=None, **kwargs):
    '''
...
def show(name, resource_group, routeserver, **kwargs):
    '''
...
def wait(name, resource_group, routeserver, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
...
def list(resource_group, routeserver, **kwargs):
    '''
...
def list_learned_routes(name, resource_group, routeserver, **kwargs):
    '''
...
def list_advertised_routes(name, resource_group, routeserver, **kwargs):
    '''
