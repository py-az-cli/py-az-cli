...
def delete(name, resource_group, service_name, **kwargs):
    '''
...
def update(connection_status, name, resource_group, service_name, action_required=None, description=None, **kwargs):
    '''
