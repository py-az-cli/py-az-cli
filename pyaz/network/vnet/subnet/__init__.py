...
def create(address_prefixes, name, resource_group, vnet_name, delegations=None, disable_private_endpoint_network_policies=None, disable_private_link_service_network_policies=None, nat_gateway=None, network_security_group=None, route_table=None, service_endpoint_policy=None, service_endpoints=None, **kwargs):
    '''
...
def delete(name, resource_group, vnet_name, **kwargs):
    '''
    Delete a subnet.
    '''
...
def show(name, resource_group, vnet_name, expand=None, **kwargs):
    '''
...
def list(resource_group, vnet_name, **kwargs):
    '''
...
def list_available_delegations(location=None, resource_group=None, **kwargs):
    '''
