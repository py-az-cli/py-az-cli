...
def delete(name, resource_group, zone_name, if_match=None, no_wait=None, yes=None, **kwargs):
    '''
...
def show(name, resource_group, zone_name, **kwargs):
    '''
...
def list(resource_group, zone_name, top=None, **kwargs):
    '''
...
def create(name, registration_enabled, resource_group, virtual_network, zone_name, no_wait=None, tags=None, **kwargs):
    '''
...
def update(name, resource_group, zone_name, add=None, force_string=None, if_match=None, no_wait=None, registration_enabled=None, remove=None, set=None, tags=None, **kwargs):
    '''
...
def wait(name, resource_group, zone_name, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
