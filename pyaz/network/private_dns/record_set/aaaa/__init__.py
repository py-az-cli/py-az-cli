...
def show(name, resource_group, zone_name, record_type=None):
    ...
    '''
    return _call_az("az network private-dns record-set aaaa show", locals())
...
def delete(name, resource_group, zone_name, if_match=None, record_type=None, yes=None):
    ...
    '''
    return _call_az("az network private-dns record-set aaaa delete", locals())
...
def list(resource_group, zone_name, record_type=None):
    ...
    - record_type -- ==SUPPRESS==
    '''
    return _call_az("az network private-dns record-set aaaa list", locals())
...
def create(name, resource_group, zone_name, metadata=None, record_type=None, ttl=None):
    ...
    '''
    return _call_az("az network private-dns record-set aaaa create", locals())
...
def add_record(ipv6_address, record_set_name, resource_group, zone_name):
    ...
    Required Parameters:
    - ipv6_address -- IPV6 address in string notation.
    - record_set_name -- The name of the record set relative to the zone. Creates a new record set if one does not exist.
    - resource_group -- Name of resource group. You can configure the default group using `az configure --defaults group=<name>`
    - zone_name -- The name of the Private DNS zone.
    '''
    return _call_az("az network private-dns record-set aaaa add-record", locals())
...
def remove_record(ipv6_address, record_set_name, resource_group, zone_name, keep_empty_record_set=None):
    ...
    '''
    return _call_az("az network private-dns record-set aaaa remove-record", locals())
...
def update(name, resource_group, zone_name, add=None, force_string=None, if_match=None, metadata=None, record_type=None, remove=None, set=None):
    ...
    '''
    return _call_az("az network private-dns record-set aaaa update", locals())
