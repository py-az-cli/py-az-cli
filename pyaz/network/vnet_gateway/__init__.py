...
def reset(name, resource_group, gateway_vip=None, **kwargs):
    '''
...
def list_bgp_peer_status(name, resource_group, peer=None, **kwargs):
    '''
...
def list_advertised_routes(name, peer, resource_group, **kwargs):
    '''
...
def list_learned_routes(name, resource_group, **kwargs):
    '''
...
def show_supported_devices(name, resource_group, **kwargs):
    '''
...
def disconnect_vpn_connections(name, resource_group, vpn_connections, no_wait=None, **kwargs):
    '''
