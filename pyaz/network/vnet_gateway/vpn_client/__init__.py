...
def generate(name, resource_group, authentication_method=None, client_root_certificates=None, processor_architecture=None, radius_server_auth_certificate=None, use_legacy=None, **kwargs):
    '''
...
def show_url(name, resource_group, **kwargs):
    '''
...
def show_health(name, resource_group, **kwargs):
    '''
