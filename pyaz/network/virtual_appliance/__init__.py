...
def create(name, resource_group, scale_unit, vendor, version, vhub, asn=None, boot_strap_config_blobs=None, cloud_init_config=None, cloud_init_config_blobs=None, location=None, tags=None, **kwargs):
    '''
...
def update(name, resource_group, add=None, asn=None, cloud_init_config=None, force_string=None, remove=None, set=None, **kwargs):
    '''
