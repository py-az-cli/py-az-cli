...
def create(name, peer_asn, peer_ip, resource_group, vrouter_name, **kwargs):
    '''
...
def update(name, resource_group, vrouter_name, add=None, force_string=None, peer_asn=None, peer_ip=None, remove=None, set=None, **kwargs):
    '''
...
def delete(name, resource_group, vrouter_name, **kwargs):
    '''
...
def show(name, resource_group, vrouter_name, **kwargs):
    '''
...
def list(resource_group, vrouter_name, **kwargs):
    '''
