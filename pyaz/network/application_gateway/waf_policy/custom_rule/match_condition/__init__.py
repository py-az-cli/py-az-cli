...
def add(match_variables, name, operator, policy_name, resource_group, values, negate=None, transforms=None, **kwargs):
    '''
...
def list(name, policy_name, resource_group, **kwargs):
    '''
...
def remove(index, name, policy_name, resource_group, **kwargs):
    '''
