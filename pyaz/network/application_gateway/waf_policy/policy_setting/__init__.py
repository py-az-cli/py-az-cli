...
def update(policy_name, resource_group, add=None, file_upload_limit_in_mb=None, force_string=None, max_request_body_size_in_kb=None, mode=None, remove=None, request_body_check=None, set=None, state=None, **kwargs):
    '''
