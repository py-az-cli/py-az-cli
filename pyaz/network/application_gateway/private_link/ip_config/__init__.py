...
def add(gateway_name, name, private_link, resource_group, ip_address=None, no_wait=None, primary=None, **kwargs):
    '''
...
def remove(gateway_name, name, private_link, resource_group, no_wait=None, yes=None, **kwargs):
    '''
...
def show(gateway_name, name, private_link, resource_group, **kwargs):
    '''
...
def list(gateway_name, private_link, resource_group, **kwargs):
    '''
...
def wait(gateway_name, resource_group, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
