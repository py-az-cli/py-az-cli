...
def add(frontend_ip, gateway_name, name, resource_group, subnet, ip_address=None, no_wait=None, primary=None, subnet_prefix=None, **kwargs):
    '''
...
def remove(gateway_name, name, resource_group, no_wait=None, yes=None, **kwargs):
    '''
