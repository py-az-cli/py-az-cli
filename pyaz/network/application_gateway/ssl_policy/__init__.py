...
def set(gateway_name, resource_group, cipher_suites=None, disabled_ssl_protocols=None, min_protocol_version=None, name=None, no_wait=None, policy_type=None, **kwargs):
    '''
