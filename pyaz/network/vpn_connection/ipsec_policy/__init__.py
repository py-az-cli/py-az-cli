...
def add(connection_name, dh_group, ike_encryption, ike_integrity, ipsec_encryption, ipsec_integrity, pfs_group, resource_group, sa_lifetime, sa_max_size, no_wait=None, **kwargs):
    '''
...
def list(connection_name, resource_group, **kwargs):
    '''
...
def clear(connection_name, resource_group, no_wait=None, **kwargs):
    '''
