...
def add(ip_address, lb_name, name, pool_name, resource_group, subnet=None, vnet=None, **kwargs):
    '''
...
def remove(lb_name, name, pool_name, resource_group, **kwargs):
    '''
...
def list(lb_name, pool_name, resource_group, **kwargs):
    '''
