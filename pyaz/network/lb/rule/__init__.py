...
def create(backend_port, frontend_port, lb_name, name, protocol, resource_group, backend_pool_name=None, backend_pools_name=None, disable_outbound_snat=None, enable_tcp_reset=None, floating_ip=None, frontend_ip_name=None, idle_timeout=None, load_distribution=None, probe_name=None, **kwargs):
    '''
