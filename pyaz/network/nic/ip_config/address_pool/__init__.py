...
def add(address_pool, ip_config_name, nic_name, resource_group, gateway_name=None, lb_name=None, **kwargs):
    '''
...
def remove(address_pool, ip_config_name, nic_name, resource_group, gateway_name=None, lb_name=None, **kwargs):
    '''
