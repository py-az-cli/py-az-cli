...
def show_effective_route_table(name, resource_group, **kwargs):
    '''
...
def list_effective_nsg(name, resource_group, **kwargs):
    '''
...
def update(name, resource_group, accelerated_networking=None, add=None, dns_servers=None, force_string=None, internal_dns_name=None, ip_forwarding=None, network_security_group=None, no_wait=None, remove=None, set=None, **kwargs):
    '''
