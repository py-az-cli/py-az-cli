...
def get_stats(name, resource_group, **kwargs):
    '''
...
def list_arp_tables(name, path, peering_name, resource_group, **kwargs):
    '''
...
def list_route_tables(name, path, peering_name, resource_group, **kwargs):
    '''
...
def list_route_tables_summary(name, path, peering_name, resource_group, **kwargs):
    '''
...
def create(bandwidth, name, peering_location, provider, resource_group, allow_classic_operations=None, allow_global_reach=None, express_route_port=None, location=None, no_wait=None, sku_family=None, sku_tier=None, tags=None, **kwargs):
    '''
...
def list_service_providers(**kwargs):
    '''
...
def update(name, resource_group, add=None, allow_classic_operations=None, allow_global_reach=None, bandwidth=None, express_route_port=None, force_string=None, no_wait=None, peering_location=None, provider=None, remove=None, set=None, sku_family=None, sku_tier=None, tags=None, **kwargs):
    '''
