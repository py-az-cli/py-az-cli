...
def create(gateway_name, name, peering, resource_group, associated=None, authorization_key=None, circuit_name=None, internet_security=None, labels=None, propagated=None, routing_weight=None, **kwargs):
    '''
...
def update(gateway_name, name, resource_group, add=None, associated=None, authorization_key=None, circuit_name=None, force_string=None, internet_security=None, labels=None, peering=None, propagated=None, remove=None, routing_weight=None, set=None, **kwargs):
    '''
