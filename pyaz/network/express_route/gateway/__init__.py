...
def create(name, resource_group, location=None, max_val=None, min_val=None, tags=None, virtual_hub=None, **kwargs):
    '''
...
def update(name, resource_group, add=None, force_string=None, max_val=None, min_val=None, remove=None, set=None, tags=None, **kwargs):
    '''
