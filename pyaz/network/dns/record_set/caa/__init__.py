...
def add_record(flags, record_set_name, resource_group, tag, value, zone_name, if_none_match=None, ttl=None, **kwargs):
    '''
    Add a CAA record.
    '''
...
def remove_record(flags, record_set_name, resource_group, tag, value, zone_name, keep_empty_record_set=None, **kwargs):
    '''
