...
def set_record(cname, record_set_name, resource_group, zone_name, if_none_match=None, ttl=None, **kwargs):
    '''
...
def remove_record(cname, record_set_name, resource_group, zone_name, keep_empty_record_set=None, **kwargs):
    '''
