...
def add_record(port, priority, record_set_name, resource_group, target, weight, zone_name, if_none_match=None, **kwargs):
    '''
    Add an SRV record.
    '''
...
def remove_record(port, priority, record_set_name, resource_group, target, weight, zone_name, keep_empty_record_set=None, **kwargs):
    '''
