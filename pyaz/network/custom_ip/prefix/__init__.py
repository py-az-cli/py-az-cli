...
def create(name, resource_group, authorization_message=None, cidr=None, cip_prefix_parent=None, location=None, no_wait=None, signed_message=None, tags=None, zone=None, **kwargs):
    '''
...
def update(name, resource_group, add=None, authorization_message=None, force_string=None, no_wait=None, remove=None, set=None, signed_message=None, state=None, tags=None, **kwargs):
    '''
