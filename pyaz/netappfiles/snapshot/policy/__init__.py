...
def show(account_name, resource_group, snapshot_policy_name, **kwargs):
    '''
...
def volumes(account_name, resource_group, snapshot_policy_name, **kwargs):
    '''
...
def delete(account_name, resource_group, snapshot_policy_name, **kwargs):
    '''
