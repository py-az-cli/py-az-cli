...
def show(account_name, name, pool_name, resource_group, volume_name, **kwargs):
    '''
...
def delete(account_name, name, pool_name, resource_group, volume_name, **kwargs):
    '''
...
def create(account_name, location, name, pool_name, resource_group, volume_name, **kwargs):
    '''
...
def update(account_name, body, name, pool_name, resource_group, volume_name, **kwargs):
