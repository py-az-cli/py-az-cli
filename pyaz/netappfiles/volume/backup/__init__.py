...
def show(account_name, backup_name, pool_name, resource_group, volume_name, **kwargs):
    '''
...
def list(account_name, pool_name, resource_group, volume_name, **kwargs):
    '''
...
def delete(account_name, backup_name, pool_name, resource_group, volume_name, **kwargs):
...
def restore_status(account_name, pool_name, resource_group, volume_name, **kwargs):
    '''
...
def update(account_name, backup_name, pool_name, resource_group, volume_name, label=None, tags=None, use_existing_snapshot=None, **kwargs):
    '''
...
def create(account_name, backup_name, location, pool_name, resource_group, volume_name, use_existing_snapshot=None, **kwargs):
    '''
