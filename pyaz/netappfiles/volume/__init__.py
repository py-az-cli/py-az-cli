...
def show(account_name, pool_name, resource_group, volume_name, **kwargs):
    '''
...
def list(account_name, pool_name, resource_group, **kwargs):
    '''
...
def delete(account_name, pool_name, resource_group, volume_name, **kwargs):
    '''
...
def revert(account_name, pool_name, resource_group, snapshot_id, volume_name, **kwargs):
    '''
...
def pool_change(account_name, new_pool_resource_id, pool_name, resource_group, volume_name, **kwargs):
    '''
