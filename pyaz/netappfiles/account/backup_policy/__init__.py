...
def show(account_name, backup_policy_name, resource_group, **kwargs):
    '''
...
def delete(account_name, backup_policy_name, resource_group, **kwargs):
    '''
...
def update(account_name, backup_policy_name, resource_group, daily_backups=None, enabled=None, location=None, monthly_backups=None, tags=None, weekly_backups=None, **kwargs):
    '''
...
def create(account_name, backup_policy_name, location, resource_group, daily_backups=None, enabled=None, monthly_backups=None, tags=None, weekly_backups=None, **kwargs):
    '''
