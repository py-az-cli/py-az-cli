...
def add(cluster_name, node_type, number_of_nodes_to_add, resource_group, **kwargs):
    '''
...
def remove(cluster_name, node_type, number_of_nodes_to_remove, resource_group, **kwargs):
    '''
