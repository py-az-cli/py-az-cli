...
def list(application, cluster_name, resource_group, **kwargs):
    '''
...
def delete(application, cluster_name, name, resource_group, **kwargs):
    '''
...
def show(application, cluster_name, name, resource_group, **kwargs):
    '''
    Get a service.
    '''
