...
def list(account_name, customer_name=None, filter=None, invoice_section_name=None, profile_name=None, **kwargs):
    '''
...
def show(account_name, name, **kwargs):
    '''
...
def update(account_name, name, auto_renew=None, billing_frequency=None, status=None, **kwargs):
    '''
...
def move(account_name, name, destination_invoice_section_id=None, **kwargs):
    '''
...
def validate_move(account_name, name, destination_invoice_section_id=None, **kwargs):
    '''
