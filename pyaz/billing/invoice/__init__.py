...
def list(period_end_date, period_start_date, account_name=None, profile_name=None, **kwargs):
    '''
...
def show(name, account_name=None, by_subscription=None, **kwargs):
    '''
...
def download(account_name=None, download_token=None, download_urls=None, invoice_name=None, **kwargs):
    '''
