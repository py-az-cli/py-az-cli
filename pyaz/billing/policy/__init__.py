...
def update(account_name, customer_name=None, marketplace_purchases=None, profile_name=None, reservation_purchases=None, view_charges=None, **kwargs):
    '''
...
def show(account_name, customer_name=None, profile_name=None, **kwargs):
    '''
