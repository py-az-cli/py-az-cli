...
def list(account_name, customer_name=None, invoice_section_name=None, profile_name=None, **kwargs):
    '''
...
def update(account_name, cost_center=None, sku_id=None, subscription_billing_status=None, **kwargs):
    '''
...
def move(account_name, destination_invoice_section_id, no_wait=None, **kwargs):
    '''
...
def validate_move(account_name, destination_invoice_section_id, **kwargs):
    '''
...
def wait(account_name, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
