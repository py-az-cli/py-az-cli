...
def show(account, data_lake_store_account_name, resource_group=None, **kwargs):
...
def add(account, data_lake_store_account_name, resource_group=None, suffix=None, **kwargs):
    return call_az("az dla account data-lake-store add", locals())


def delete(account, data_lake_store_account_name, resource_group=None, **kwargs):
