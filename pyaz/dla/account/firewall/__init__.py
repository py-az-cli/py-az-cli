...
def create(account, end_ip_address, firewall_rule_name, start_ip_address, resource_group=None, **kwargs):
    '''
...
def update(account, firewall_rule_name, end_ip_address=None, resource_group=None, start_ip_address=None, **kwargs):
    '''
...
def show(account, firewall_rule_name, resource_group=None, **kwargs):
    '''
...
def delete(account, firewall_rule_name, resource_group=None, **kwargs):
    '''
