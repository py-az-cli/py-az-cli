...
def create(account, compute_policy_name, object_id, object_type, max_dop_per_job=None, min_priority_per_job=None, resource_group=None, **kwargs):
    '''
...
def update(account, compute_policy_name, max_dop_per_job=None, min_priority_per_job=None, resource_group=None, **kwargs):
    '''
...
def list(account, resource_group=None, **kwargs):
    '''
...
def show(account, compute_policy_name, resource_group=None, **kwargs):
    '''
...
def delete(account, compute_policy_name, resource_group=None, **kwargs):
    '''
