...
def create(name, resource_group, server, **kwargs):
...
def set(name, original_server, resource_group, server, original_resource_group=None, original_subscription_id=None, **kwargs):
    '''
