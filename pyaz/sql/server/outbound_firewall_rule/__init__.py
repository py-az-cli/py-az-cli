...
def create(outbound_rule_fqdn, resource_group, server, **kwargs):
    '''
...
def delete(outbound_rule_fqdn, resource_group, server, **kwargs):
    '''
...
def show(outbound_rule_fqdn, resource_group, server, **kwargs):
    '''
