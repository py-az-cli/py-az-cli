...
def start(managed_instance, name, resource_group, storage_sas, storage_uri, auto_complete=None, last_backup_name=None, no_wait=None, **kwargs):
    '''
...
def stop(managed_instance, name, resource_group, no_wait=None, yes=None, **kwargs):
    '''
...
def complete(managed_instance, name, resource_group, last_backup_name=None, **kwargs):
    '''
...
def wait(managed_instance, name, resource_group, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
