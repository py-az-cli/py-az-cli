...
def add_to_group(name, resource_group, sqlvm_group, operator_acc_pwd=None, service_acc_pwd=None, **kwargs):
    '''
...
def remove_from_group(name, resource_group, **kwargs):
    '''
