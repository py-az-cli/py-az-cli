...
def update(name, resource_group, add=None, bootstrap_acc=None, domain_fqdn=None, force_string=None, fsw_path=None, operator_acc=None, ou_path=None, remove=None, sa_key=None, service_acc=None, set=None, storage_account=None, tags=None, **kwargs):
    '''
...
def create(domain_fqdn, image_offer, image_sku, name, operator_acc, resource_group, service_acc, storage_account, bootstrap_acc=None, fsw_path=None, location=None, ou_path=None, sa_key=None, tags=None, **kwargs):
    '''
