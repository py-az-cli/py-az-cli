...
def set(diffbackup_hours, name, resource_group, retention_days, server, no_wait=None, **kwargs):
    '''
...
def wait(name, policy_name, resource_group, server, created=None, custom=None, deleted=None, exists=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
