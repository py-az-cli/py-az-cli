...
def list(name, resource_group, server, count=None, filter=None, skip_token=None, **kwargs):
    '''
...
def show(column, name, resource_group, schema, server, table, **kwargs):
    '''
...
def delete(column, name, resource_group, schema, server, table, **kwargs):
    '''
...
def update(column, name, resource_group, schema, server, table, information_type=None, label=None, **kwargs):
    '''
