...
def list(name, resource_group, server, filter=None, include_disabled_recommendations=None, **kwargs):
    '''
...
def enable(column, name, resource_group, schema, server, table, **kwargs):
    '''
...
def disable(column, name, resource_group, schema, server, table, **kwargs):
    '''
