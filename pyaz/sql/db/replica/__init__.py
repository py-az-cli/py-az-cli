...
def list_links(name, resource_group, server, **kwargs):
    '''
...
def delete_link(name, partner_server, resource_group, server, partner_resource_group=None, yes=None, **kwargs):
    '''
...
def set_primary(name, resource_group, server, allow_data_loss=None, **kwargs):
    '''
