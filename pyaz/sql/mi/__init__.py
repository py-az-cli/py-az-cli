...
def show(name, resource_group, expand_ad_admin=None, **kwargs):
    '''
...
def list(expand_ad_admin=None, resource_group=None, **kwargs):
    '''
...
def failover(name, resource_group, no_wait=None, replica_type=None, **kwargs):
    '''
