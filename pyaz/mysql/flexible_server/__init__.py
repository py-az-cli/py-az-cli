...
def restore(name, resource_group, source_server, address_prefixes=None, no_wait=None, private_dns_zone=None, public_access=None, restore_time=None, subnet=None, subnet_prefixes=None, vnet=None, yes=None, zone=None, **kwargs):
    '''
...
def geo_restore(location, name, resource_group, source_server, address_prefixes=None, no_wait=None, private_dns_zone=None, public_access=None, subnet=None, subnet_prefixes=None, vnet=None, yes=None, zone=None, **kwargs):
    '''
...
def stop(name=None, resource_group=None, **kwargs):
    '''
...
def update(name, resource_group, add=None, admin_password=None, backup_retention=None, force_string=None, high_availability=None, iops=None, maintenance_window=None, remove=None, replication_role=None, set=None, sku_name=None, standby_zone=None, storage_auto_grow=None, storage_size=None, tags=None, tier=None, **kwargs):
    '''
...
def restart(name, resource_group, failover=None, **kwargs):
    '''
