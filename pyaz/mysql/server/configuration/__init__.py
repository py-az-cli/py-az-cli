...
def set(name, resource_group, server_name, value=None):
    ...
    '''
    return call_az("az mysql server configuration set", locals())
...
def show(name, resource_group, server_name):
    ...
    '''
    return call_az("az mysql server configuration show", locals())
...
def list(resource_group, server_name):
    ...
    '''
    return call_az("az mysql server configuration list", locals())
