...
def create(name, resource_group, location=None, no_wait=None, tags=None, **kwargs):
    '''
...
def update(name, resource_group, add=None, force_string=None, no_wait=None, remove=None, set=None, tags=None, **kwargs):
    '''
