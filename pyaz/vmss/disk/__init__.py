...
def attach(resource_group, vmss_name, caching=None, disk=None, instance_id=None, lun=None, size_gb=None, sku=None, **kwargs):
    '''
...
def detach(lun, resource_group, vmss_name, instance_id=None, **kwargs):
    '''
