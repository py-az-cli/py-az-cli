...
def deallocate(name, resource_group, instance_ids=None, no_wait=None, **kwargs):
    '''
...
def delete(name, resource_group, force_deletion=None, no_wait=None, **kwargs):
    return call_az("az vmss delete", locals())


def delete_instances(instance_ids, name, resource_group, no_wait=None, **kwargs):
    '''
...
def get_instance_view(name, resource_group, instance_id=None, **kwargs):
    '''
...
def list_instances(name, resource_group, expand=None, filter=None, select=None, **kwargs):
    '''
...
def list_instance_connection_info(name, resource_group, **kwargs):
    '''
...
def list_instance_public_ips(name, resource_group, **kwargs):
    '''
...
def list_skus(name, resource_group, **kwargs):
    return call_az("az vmss list-skus", locals())


def reimage(name, resource_group, instance_id=None, no_wait=None, **kwargs):
    '''
...
def perform_maintenance(name, resource_group, vm_instance_i_ds=None, **kwargs):
    return call_az("az vmss perform-maintenance", locals())


def restart(name, resource_group, instance_ids=None, no_wait=None, **kwargs):
    '''
...
def scale(name, new_capacity, resource_group, no_wait=None, **kwargs):
    '''
...
def show(name, resource_group, include_user_data=None, instance_id=None, **kwargs):
    '''
...
def simulate_eviction(instance_id, name, resource_group, **kwargs):
    '''
...
def start(name, resource_group, instance_ids=None, no_wait=None, **kwargs):
    '''
...
def stop(name, resource_group, instance_ids=None, no_wait=None, skip_shutdown=None, **kwargs):
    '''
...
def update_instances(instance_ids, name, resource_group, no_wait=None, **kwargs):
    '''
...
def wait(name, resource_group, created=None, custom=None, deleted=None, exists=None, instance_id=None, interval=None, timeout=None, updated=None, **kwargs):
    '''
...
def get_os_upgrade_history(name, resource_group, **kwargs):
    return call_az("az vmss get-os-upgrade-history", locals())


def set_orchestration_service_state(action, name, resource_group, service_name, no_wait=None, **kwargs):
    '''
