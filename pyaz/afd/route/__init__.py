...
def show(endpoint_name, profile_name, resource_group, route_name, **kwargs):
    '''
    Show route details.
    '''
...
def delete(endpoint_name, profile_name, resource_group, route_name, yes=None, **kwargs):
    '''
