...
def show(profile_name, resource_group, **kwargs):
    '''
...
def delete(profile_name, resource_group, **kwargs):
    '''
...
def update(profile_name, resource_group, tags, **kwargs):
    '''
...
def create(profile_name, resource_group, sku, tags=None, **kwargs):
    '''
...
def usage(profile_name, resource_group, **kwargs):
    '''
