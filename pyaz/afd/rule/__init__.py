...
def show(profile_name, resource_group, rule_name, rule_set_name, **kwargs):
    '''
...
def delete(profile_name, resource_group, rule_name, rule_set_name, yes=None, **kwargs):
    '''
