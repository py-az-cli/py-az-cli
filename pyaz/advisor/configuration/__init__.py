...
def show(resource_group=None, **kwargs):
    '''
...
def update(add=None, configuration_name=None, exclude=None, force_string=None, include=None, low_cpu_threshold=None, remove=None, resource_group=None, set=None, **kwargs):
    '''
