...
def add(customizer_name, name, resource_group, type, dest_path=None, exit_codes=None, file_source=None, filters=None, inline_script=None, restart_check_command=None, restart_command=None, restart_timeout=None, script_url=None, search_criteria=None, update_limit=None, **kwargs):
    '''
...
def remove(customizer_name, name, resource_group, **kwargs):
    '''
