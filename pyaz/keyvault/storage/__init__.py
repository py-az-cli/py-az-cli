...
def add(active_key_name, name, resource_id, vault_name, auto_regenerate_key=None, disabled=None, regeneration_period=None, tags=None, **kwargs):
...
def show(id=None, name=None, vault_name=None, **kwargs):
    return call_az("az keyvault storage show", locals())


def update(active_key_name=None, auto_regenerate_key=None, disabled=None, id=None, name=None, regeneration_period=None, tags=None, vault_name=None, **kwargs):
    return call_az("az keyvault storage update", locals())


def remove(id=None, name=None, vault_name=None, **kwargs):
    '''
...
def regenerate_key(key_name, id=None, name=None, vault_name=None, **kwargs):
    return call_az("az keyvault storage regenerate-key", locals())


def list_deleted(vault_name, maxresults=None, **kwargs):
    return call_az("az keyvault storage list-deleted", locals())


def show_deleted(name, vault_name, **kwargs):
    return call_az("az keyvault storage show-deleted", locals())


def purge(name, vault_name, **kwargs):
    return call_az("az keyvault storage purge", locals())


def recover(name, vault_name, **kwargs):
