...
def recover(hsm_name=None, location=None, name=None, no_wait=None, resource_group=None, **kwargs):
    '''
...
def list(resource_group=None, resource_type=None, **kwargs):
    '''
...
def show(hsm_name=None, name=None, resource_group=None, **kwargs):
    '''
...
def delete(hsm_name=None, name=None, no_wait=None, resource_group=None, **kwargs):
    '''
...
def purge(hsm_name=None, location=None, name=None, no_wait=None, **kwargs):
    '''
...
def set_policy(name, application_id=None, certificate_permissions=None, key_permissions=None, no_wait=None, object_id=None, resource_group=None, secret_permissions=None, spn=None, storage_permissions=None, upn=None, **kwargs):
    '''
...
def delete_policy(name, application_id=None, no_wait=None, object_id=None, resource_group=None, spn=None, upn=None, **kwargs):
    return call_az("az keyvault delete-policy", locals())


def list_deleted(resource_type=None, **kwargs):
    '''
...
def show_deleted(hsm_name=None, location=None, name=None, **kwargs):
    '''
...
def wait(name, created=None, custom=None, deleted=None, exists=None, interval=None, resource_group=None, timeout=None, updated=None, **kwargs):
    '''
...
def update_hsm(hsm_name, add=None, bypass=None, default_action=None, enable_purge_protection=None, force_string=None, no_wait=None, remove=None, resource_group=None, secondary_locations=None, set=None, **kwargs):
    '''
...
def wait_hsm(hsm_name, created=None, custom=None, deleted=None, exists=None, interval=None, resource_group=None, timeout=None, updated=None, **kwargs):
    '''
